...
HD_PWD='C:/Users/Mike/Documents/osiris-hdl/projects/zybo_linebuffer_test/zybo_linebuffer_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log linebuffer_test_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source linebuffer_test_wrapper.tcl
