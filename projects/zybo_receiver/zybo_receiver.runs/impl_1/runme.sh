...
HD_PWD='C:/Users/Mike/Documents/osiris-hdl/projects/zybo_receiver/zybo_receiver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_receiver_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source zybo_receiver_wrapper.tcl -notrace
