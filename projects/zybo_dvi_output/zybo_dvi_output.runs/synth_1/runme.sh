...
HD_PWD='C:/Users/Mike/Documents/osiris-hdl/projects/zybo_dvi_output/zybo_dvi_output.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_dvi_output_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source zybo_dvi_output_wrapper.tcl
