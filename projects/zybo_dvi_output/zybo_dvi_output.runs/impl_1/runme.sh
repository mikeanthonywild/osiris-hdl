...
HD_PWD='C:/Users/Mike/Documents/osiris-hdl/projects/zybo_dvi_output/zybo_dvi_output.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_dvi_output_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source zybo_dvi_output_wrapper.tcl -notrace
