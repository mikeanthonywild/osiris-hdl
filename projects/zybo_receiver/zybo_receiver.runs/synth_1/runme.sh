...
HD_PWD='C:/Users/Mike/Documents/osiris-hdl/projects/zybo_receiver/zybo_receiver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_receiver_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source zybo_receiver_wrapper.tcl
