...
HD_PWD='C:/Users/Mike/Documents/osiris-hdl/projects/zybo_dvi_input/zybo_dvi_input.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_dvi_input_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source zybo_dvi_input_wrapper.tcl
