...
HD_PWD='C:/Users/Mike/Documents/osiris-hdl/projects/zybo_linebuffer_test/zybo_linebuffer_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log linebuffer_test_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source linebuffer_test_wrapper.tcl -notrace
